...
combo_t key_combos[] = {
    COMBO(to_dvorak1, PDF(_DVRK)),   // Press ESC and D to switch to Dvorak
    COMBO(to_dvorak2, PDF(_DVRK)),   // Press ESC and E to switch to Dvorak
    COMBO(to_qwerty1, PDF(_BASE)),   // Press ESC and Q to switch to Qwerty
    COMBO(to_qwerty2, PDF(_BASE))    // press ESC and ' to switch to Qwerty
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_emma46(  
        KC_ESC,     KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,           KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,    KC_BSLS,  //12 keys
//     └───────┘   └───────┴───────┴───────┴───────┴───────┘       └───────┴───────┴───────┴───────┴───────┴───────┘    
...
//     └───────┘                   └───────┴───────┴───────┘       └───────────────┴───────┘                        └──────┴───────┴────────┘        
    ...
    [_DVRK] = LAYOUT_emma46(  //DVORAK layout
        KC_ESC,     KC_QUOT,KC_COMM,KC_DOT,  KC_P,   KC_Y,           KC_F,   KC_G,   KC_C,   KC_R,   KC_L,  KC_SLSH,  //12 keys
//     └───────┘   └───────┴───────┴───────┴───────┴───────┘       └───────┴───────┴───────┴───────┴───────┴───────┘    
...
//     └───────┘   └───────┴───────┴───────┴───────┴───────┘       └───────┴───────┴───────┴───────┴───────┴───────┘    
         ____,      KC_LPRN,KC_RPRN,KC_LBRC,KC_RBRC, KC_EQL,        KC_PLUS,KC_MINS,KC_LCBR,KC_RCBR, ____,  KC_PIPE,        KC_INS, 
//     └───────┘   └───────┴───────┴───────┴───────┴───────┘       └───────┴───────┴───────┴───────┴───────┴───────┘       └───────┘    
